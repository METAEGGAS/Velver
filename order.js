...
</style><section id=odpg><div class=owrap><div class=topt><button class=wb id=odback><img src="https://i.ibb.co/vv1DbtK0/65.png" alt=""></button><h2>History</h2></div><div class=htabs><button class="htab on" data-v=Deposit>Deposit</button><button class=htab data-v=Withdraw>Withdraw</button></div><div class=nd><img src="https://cdn3d.iconscout.com/3d/premium/thumb/no-results-3d-icon-png-download-6672513.png" alt=""><b>No data</b></div></div></section>`;
let q=s=>d.querySelector(s),qa=s=>d.querySelectorAll(s);
q("#odback").onclick=()=>closeDyn();
qa(".htab").forEach(b=>b.onclick=()=>qa(".htab").forEach(x=>x.classList.toggle("on",x===b)));
})();
